...
export const LoginCodeEmail = ({ url, code }: Props) => (
  <Html>
    <Head />
    <Preview>Your login code for AI Chat Bot Pro</Preview>
    <Body style={main}>
      <Container style={container}>
        <Logo />
        <Heading style={heading}>Your login code for AI Chat Bot Pro</Heading>
...
export const sendLoginCodeEmail = async ({
  ...
  sendEmail({
    to,
    subject: "Sign in to AI Chat Bot Pro",
