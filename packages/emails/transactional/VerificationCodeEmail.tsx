...
export const VerificationCodeEmail = ({ code }: Props) => (
  <Html>
    <Head />
    <Preview>Your verification code for AI Chat Bot Pro</Preview>
    <Body style={main}>
      <Container style={container}>
        <Logo />
        <Heading style={heading}>Your verification code for AI Chat Bot Pro</Heading>
...
export const sendVerificationCodeEmail = async ({
  ...
  sendEmail({
    to,
    subject: "Your verification code for AI Chat Bot Pro",
