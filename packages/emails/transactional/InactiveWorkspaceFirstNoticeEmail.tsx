    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={paragraph}>
          It&apos;s been at least 60+ days since{" "}
          <strong>{workspaceName}</strong> workspace has been inactive. Meaning
          you did not log in or your bots did not get any traffic in the last 60
          days. <br />
          <br />
          <strong>
            We&apos;ve automatically scheduled it for deletion in 30 days.
          </strong>{" "}
          All its bots and collected results will be permanently deleted.
        </Text>
        <Text>
        ...
        <Text style={paragraph}>
          ...
          >
            log in to your AI Chat Bot Pro account
          </Link>{" "}
          and it will be marked as active again.
        </Text>
        <Text style={paragraph}>
          This can be a good opportunity to explore what&apos;s new! A lot of
          new features have been added since you last logged in including new
          blocks, more AI integrations and a ton of other improvements.
        </Text>
        <Hr style={hr} />
        <Text style={footerText}>
          AI Chat Bot Pro - Build faster, Chat smarter
        </Text>
        <Link
          href="{{unsubscribe}}"
          target="_blank"
...
export const sendInactiveWorkspaceFirstNoticeEmail = async ({
  ...
  sendEmail({
    to,
    subject: `Your '${props.workspaceName}' workspace is inactive and will be deleted soon`,
