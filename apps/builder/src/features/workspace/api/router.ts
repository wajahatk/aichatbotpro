...
import {
  getOrgStatsInputSchema,
  handleGetOrgStats,
  orgStatsSchema,
} from "./handleGetOrgStats";
import {
...
export const workspaceRouter = {
  ...
  getOrgStats: authenticatedProcedure
    .route({
      method: "GET",
      path: "/v1/workspaces/{workspaceId}/org-stats",
      summary: "Get organization usage stats and plan",
      tags: ["Workspace"],
    })
    .input(getOrgStatsInputSchema)
    .output(orgStatsSchema)
    .handler(handleGetOrgStats),
};
