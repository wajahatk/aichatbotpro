  ...
  return (
    <div className="flex w-full border-b justify-center items-center relative h-(--header-height) bg-gray-1 shrink-0 z-10">
      <div className="items-center gap-2 absolute xl:static right-[280px] xl:right-0 hidden sm:flex">
        ...
        <ButtonLink
          href={`/chatbots/${typebot?.id}/theme`}
        ...
        <ButtonLink
          href={`/chatbots/${typebot?.id}/settings`}
              ...
              href={
                !user
                  ? {
                      pathname: "/register",
                      query: {
                        redirectPath: `/chatbots/${typebot.id}/duplicate`,
                      },
                    }
                  : `/chatbots/${typebot.id}/duplicate`
              }
              variant="secondary"
