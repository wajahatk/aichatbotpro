  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      ...
      {currentUserMode === "guest" && (
        <ButtonLink
          href={`/chatbots/${typebot?.id}/duplicate`}
...
const TypebotNav = ({
  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      ...
      <ButtonLink
        href={`/chatbots/${typebotId}/settings`}
      ...
      {isResultsDisplayed && (
        <ButtonLink
          href={`/chatbots/${typebotId}/results`}
